  ...
  return (
    <>
     <div className='text-center'>
      <h1 id='title' className='text-white'>MY todo</h1><br />
      <form>
      ...
      className='form-control mb-1'
        ...
        required/>
        <br/> <br/>
      <button  onClick={addTodo} className='glow-on-hover mb-3 mt-3'>{editMode ? 'Update' : 'Add Todo'}</button>
      </div>
      </form>
      <br/>
      </div>
      <div className='mytodos'>
      <h3 className='m-3'><b>My ToDo's</b></h3>
      <div className='mb-3'>

    ...
    return (
        <div
         ...
         <div className="m-3">
          ...
          <div className="mb-2">
            <label name="status" className="me-1">
              <b id="status">Status:</b>
            </label>
            <select
              className={
                todo.status === "Completed"? "background-green": "background-red"}
              value={todo.status}
              name="status"
              ...
              <option
                value="Completed"
                className={
                  todo.status === "Completed" ? "background-green" : ""}>
                Completed
              </option>
              <option
                value="Not Completed"
                className={
                  todo.status !== "Completed" ? "background-red text-white" : ""}>
                Not Completed
              </option>
            </select>
            </div>
